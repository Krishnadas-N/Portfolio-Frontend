...
@Component({
  ...
  standalone: true,
  imports: [],
  template: `<iframe width="350" height="430" allow="microphone;" src="https://console.dialogflow.com/api-client/demo/embedded/f769bc89-eb5e-4b26-81fb-7bb1882ad546"></iframe>
`,
})
